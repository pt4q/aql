package pl.com.pt4q.product_manager.modules.product.ui.product_manufacturer;
...
@CssImport(ProductManufacturerView.CSS)
@Route(value = ProductManufacturerView.ROUTE, layout = MainView.class)
//@RouteAlias(value = "", layout = MainView.class)
@PageTitle(ProductManufacturerView.PAGE_TITLE)
public class ProductManufacturerView extends VerticalLayout {
    ...
    @Autowired
    public ProductManufacturerView(ProductCategoryCrudService productCategoryCrudService) {
