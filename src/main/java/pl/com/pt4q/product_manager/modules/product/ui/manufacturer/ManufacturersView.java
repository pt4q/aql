...
@CssImport(ManufacturersView.CSS)
@Route(value = ManufacturersView.ROUTE, layout = MainView.class)
//@RouteAlias(value = "", layout = MainView.class)
@PageTitle(ManufacturersView.PAGE_TITLE)
public class ManufacturersView extends VerticalLayout {
    ...
    @Autowired
    public ManufacturersView(ManufacturerCrudService manufacturerCrudService) {
